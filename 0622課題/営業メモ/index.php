    ...
    <header>
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header"><a class="navbar-brand" href="select.php">企業情報の登録</a></div>
                <div class="userbtn">
                               <input type="button" value="企業情報一覧へ" onClick="document.location='../select.php';">
                <input type="button" value="ユーザー登録へ" onClick="document.location='ユーザー管理/index.php';">
                <input type="button" value="ユーザー一覧へ" onClick="document.location='ユーザー管理/select.php';">
                </div>
            </div>
        </nav>
    </header>
