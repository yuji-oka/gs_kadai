...
--
-- Host: localhost
-- Generation Time: 2017 年 6 月 22 日 13:18
-- サーバのバージョン： 5.6.21
-- PHP Version: 5.6.3
...
('九州', '九州', '九州', '九州', '2017-06-11 22:02:35'),
('サイバーダイン', 'メーカー', 'エンジニア', '', '2017-06-15 19:17:12'),
('サイバーダイン', 'メーカー', 'エンジニア', 'やばいHALを製造していることで知られる。これは、装着することによって身体機能を拡張・増幅・補助することができる世界初のサイボーグ型ロボットであり、製品としてレンタル方式およびリース方式でのみ提供されていた[3]。これは山海が「今はまだ黎明期の技術で開発の進化が早いため、購入した製品がわずか1～2年で旧機種扱いになるのはユーザーに申し訳ない。」と考えており、またレンタルだと提供した全製品を自社で管理出来るため新機種への移行も比較的容易で、どのように使われているかも把握しているため、悪用への抑止効果もあるという。', '2017-06-15 19:20:12'),
('a', 'a', 'a', 'a', '2017-06-15 20:44:11'),
('１', '１', '１', 'q', '2017-06-15 20:58:57'),
('株式会社オープンハウス・アーキテクト', 'IT業界', '未経験歓迎の営業', '▼5年後の売上600億円を目指して「年間80名」の積極採用を進めます。\r\n1991年の創業以来「ローコスト・ハイクオリティ」をポリシーに東京多摩地区を中心に年間2000棟以上の住宅を供給しているオープンハウス・アーキテクト。東証一部上場の大手不動産会社「オープンハウス」のグループ会社で、10月1日に「アサカワホーム」から社名変更しました。', '2017-06-15 21:13:15'),
('A', '', '', '', '2017-06-17 13:50:32'),
('A株式会社', 'メーカー', 'エンジニア', 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', '2017-06-17 13:53:23'),
('あ', 'あ', 'あ', 'あ', '2017-06-17 14:00:40'),
('s', 's', 's', 's', '2017-06-17 16:23:09'),
('s', 's', 's', 's', '2017-06-17 16:45:18');
